...
Sixteen declarations are no longer `sorry` but proved.  Of Milestone 1:
...
`StronglySeparatesPoints.separatesPoints`.  Of Milestone 5, since 2026-09-06:
...
along, and `of_tendstoUniformly_of_mono_lim`, its first step.
