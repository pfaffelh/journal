...
\newcommand{\leanlogo}{\raisebox{-0.08cm}{\includegraphics[height=0.5cm]{lean_logo.png}}}
\usepackage{refcheck}
...
\begin{frame}
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \begin{minipage}[c]{2.6cm}
      \centering
      \includegraphics[height=2.2cm,keepaspectratio]{leo.jpg}
    \end{minipage}\hspace{0.7em} \\[1ex] %
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \begin{minipage}[c]{2.6cm}
      \centering
      \includegraphics[height=2.2cm,keepaspectratio]{buzzard.jpeg}
    \end{minipage}\hspace{0.7em}\\[1ex]%
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \begin{minipage}[c]{2.6cm}
      \centering
      \includegraphics[height=2.2cm,keepaspectratio]{johan.jpg}
    \end{minipage}\hspace{0.7em}\\[1ex]%
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \begin{minipage}[c]{2.6cm}
      \centering
      \includegraphics[height=2.2cm,keepaspectratio]{tao1.png}
    \end{minipage}\hspace{0.7em} \\[1ex]%
    \begin{minipage}[c]{3.2cm} 
...
\begin{frame}
  ...
  \vfill
  \hfill\includegraphics[trim=280 200 280 130,clip,height=2.8cm]{import.png}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \centerline{\fbox{The probability monad is the Kleisli triple $(\mathrm{DiscreteMeasure},\; \texttt{dirac},\; \texttt{bind})$.}}
...
\begin{frame}
  ...
  \parbox[t]{0.5\textwidth}{ \includegraphics[width=\textwidth]{nng.png}}
