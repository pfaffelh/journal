...
GROUPS = {
    ...
    "G26 the inverse in ENNReal, and the process the truncation needs": {
        "rateInverseE",
        "rateInverseE_congr",
        "rateInverseE_eq_top_of_forall_lt",
        "rateInverseE_eq_ofReal_of_exists",
        "rateInverseE_ne_top_iff",
        "rateInverseE_zero",
        "monotone_rateInverseE",
        "exists_le_cumulativeRateF_of_tendsto",
        "rateInverseE_eq_ofReal",
        "cumulativeRateF_rateInverse_of_exists",
        "rateInverse_lt_rateInverse",
        "jumpTimeFE",
        "jumpTimeFE_zero",
        "monotone_jumpTimeFE",
        "jumpTimeFE_eq_ofReal",
        "lt_jumpTimeFE_succ",
        "jumpTimeFE_lt_succ_of_lt_succ",
        "exists_ofReal_lt_jumpTimeFE",
        "jumpProcessFE",
        "isStepPath_jumpProcessFE",
        "isCadlagPath_jumpProcessFE",
        "jumpProcessFE_eq_jumpProcessF",
        "rateInverseE_truncRateF_eq_top_of_lt",
