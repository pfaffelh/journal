# Archiv erledigter vorrangiger Aufgaben

Dies ist **kein** Auftrag und wird von keinem Lauf gelesen. Hier stehen die
abgeschlossenen vorrangigen Aufgaben samt ihren Ergebnissen und Zwischenständen,
ausgelagert am 2026-09-10 aus `scripts/facts_prompt.md`, weil der Prompt auf
132 KB gewachsen war und jeder Lauf die ganze Aktenlage mitlas. Wer nachsehen
will, wie eine frühere Aufgabe ausgegangen ist, findet es hier; die Berichte
selbst stehen ohnehin in `Facts/INVENTAR.md`.

### ~~Drei Aufgaben A, B, C in dieser Reihenfolge~~ *(gestellt 2026-09-26 vom Nutzer, bis auf B2 und Reste von C erledigt in den Läufen 07:03 bis 17:03 UTC)*

**Ergebnis.** A erledigt bis auf „cutting down to an open subset“ (A5). B1, B3, B4 erledigt; B2 offen. C1, C2, C4 erledigt; C3 und C5 teilweise. Am 2026-09-26 abends durch die Aufgaben D (B2) und E (Rest von C) ersetzt. Berichte in `Facts/INVENTAR.md`.
...
### ~~Einschub: `duality_of_atomless` ohne unendliche Masse~~ *(gestellt 2026-09-25 nachts vom Nutzer, erledigt im Lauf 20260925T220301Z)*

**Ergebnis.** `duality_of_atomless` ohne `hunb`; der vorgeschlagene Weg über `ψ · 1_{s < L}` trug nicht, statt dessen `lem:calculus` auf dem Quadrat. Bericht in `Facts/INVENTAR.md`. Am 2026-09-26 durch die drei Aufgaben A, B, C ersetzt.
...
### ~~Aufgabe: das lokale Martingalproblem, Meilenstein 6~~ *(gestellt 2026-09-25 abends vom Nutzer, erledigt 2026-09-26 im Lauf 20260926T010301Z)*

**Ergebnis.** Alle sieben Schritte; Schritt 2 nur für endliche Familien, 3(a) nur unter (L1) oder bei beschränkten Sprüngen, 4 und 5 nur auf dem kanonischen Raum, Schritt 7 mit einem begründeten Nein zur Formulierung des Manuskripts. `check_master.py` sauber. Die Einschränkungen sind Aufgabe B vom 2026-09-26.
...
### ~~Aufgabe: die vier Punkte in dieser Reihenfolge~~ *(gestellt 2026-09-24 vom Nutzer, erledigt am selben Tag in zwölf Läufen)*
...
## Erledigte Punkte der Teile A bis C *(ausgelagert 2026-09-10)*
...
## Zwischenstände zu Teil C, Punkt 5 (7. bis 16. Lauf des 2026-09-10)
...
## Teil B, Punkt 2 — die Skorohod-Darstellung *(erledigt 2026-09-09)*
